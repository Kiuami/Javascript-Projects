...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Second_Perand is true and sets Dsiplay_Value
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //We are saying that if the Display_Value does not contain a decmial point we want to add a decimal point.
...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the screen to a number and then stores the result
    //inside of Calculator.First_Operand if it doesn't already exist.

...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(Element => Element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Active player may only be 'X' or 'O' so, if not 'O' it must be 'O'
        } else {
...
//This function takes a string parameter of the path you set earlier for sounds like ('./media/place.mp3')
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) { //This function utilizes HTML canvas to draw win lines.
    ...
    function animateLineDrawing() { //This function interacts with the canvas.
        ...
        if ( x1 <= x2 && y1 <= y2 ) {
            ...
            if ( x < x2 ) { x += 10; }
            //This condition adds 10 to the previous end y endpoiny. 
            if ( y < y2 ) { y += 10; }
    ...
    //This function clears our canvas after ourwin line is drawn.
    function clear() {
